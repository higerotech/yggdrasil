...
> Gate 3 (Testing) en curso sobre el despliegue de `v0.4.0` en midgard (TA-01: primer intento fallido por paquetes GHCR privados; segundo con el stack completo arriba pero healthcheck agotado por el primer arranque de Grafana; `health_timeout` 300 s): TA-01 despliegue continuo, aceptación de RF01–RF09, seguridad TS-01..TS-10, RNF01/RNF02 y calibración del techo de throughput. Al aprobarlo, cortar 0.5.0.
