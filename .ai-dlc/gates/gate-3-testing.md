...
- [ ] TA-12 RNF01 (RAM ≤ 1.5 GB, CPU media < 10 %) medido 24 h; TA-13 RNF02 tras reinicio del appliance; TA-14 Recuperando → Saludable en 5 min — TA-12 en curso (24 h desde 2026-09-08 01:02 UTC); TA-13 pendiente de HITL (reinicio); TA-14 hecho (hallazgos → v0.4.7) — TA-14 hecho (hallazgos → v0.4.7). **TA-13 ejecutado el 2026-09-08: FALLÓ**, Gjallarhorn no volvió; corregido con `yggdrasil-arranque.service` (v0.4.9), pendiente de repetir el reinicio. TA-12 en curso con un hueco de 27 min por el propio reinicio
