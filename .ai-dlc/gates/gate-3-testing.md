...
- [x] TA-12 RNF01, TA-13 RNF02 y TA-14 (2026-09-09). **TA-12 superado**: 25 muestras horarias, RAM media 401 MiB y máxima 554 (límite 1536), CPU de contenedores media 1,7 % y máxima 4,3 % (límite 10 %); cubre 23 h 31 min en vez de 24 h por el corte de corriente, desviación aceptada. **TA-13 superado**: falló en el reinicio de las 12:12 (Gjallarhorn no volvió), se corrigió con `yggdrasil-arranque.service` (v0.4.9) y la repetición llegó sola con el corte de corriente de las 23:17. **TA-14 hecho** (hallazgos → v0.4.7)
...
- [x] **HITL**: Jeremi acepta los resultados, el techo calibrado y el residual (2026-09-09). Desviaciones aceptadas: latencia de alertado medida como SLO, TS-02 con evidencia indirecta, TA-12 sobre 23 h 31 min y riesgo USB de `wan2` aceptado con vigilancia. Se corta `0.5.0`
