...
## Contexto
RF01–RF06 exigen sondeo activo por WAN, reglas SLO, 30 días de retención, dashboards y alertas, en un host con 8 GB de RAM que además hospedará Frigate. Origen: `docs/01-requirements/isp-sla-monitor.md`.
...
- Negativas / deuda asumida: vigilar RAM al sumar Frigate; si aprieta, migrar TSDB a VictoriaMetrics (compatible) — condición de revisión.
